        ...
        <div className=" bg-negroNike w-full laptop:h-[420px] relative">
            <div className="laptop:flex p-8 justify-between">
                ...
                <div className=" pt-8 flex justify-between laptop:pt-0 laptop:flex-col laptop:justify-normal">
                    <img className=" w-32 cursor-pointer" src="https://nikearprod.vtexassets.com/assets/vtex/assets-builder/nikearprod.store/2.0.77/logos/Renaper-logo___2cfbcdca6b0b070808af1c579ff76dd9.png" alt="" />
                    <img className="w-8 cursor-pointer" src="https://nikearprod.vtexassets.com/assets/vtex.file-manager-graphql/images/3b08c03e-be05-49c1-9579-193190c40b2e___d5b5ce1ab2c443765cd3beb7183e1cae.jpg" alt="" />
                </div>
            ...
            <div className="bg-negroNike absolute border-y-[1px] border-zinc-800 laptop:top-full w-full p-4">
                <div className="tablet:flex justify-between items-center">
                    <div className="text-center laptop:flex items-center gap-1">
                        ...
                        <p className=" text-[10px] text-zinc-500 ml-2 cursor-pointer hover:text-white">© 2023 Southbay S.R.L. Todos los derechos reservados.</p>
                    </div>
